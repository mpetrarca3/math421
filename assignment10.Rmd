...
Ans: In terms of testing accuracy, the best model that has been trained is the `forest1` model. This was the first forest made from question 5, and was created with the seed set to 2550. This model produce the highest testing accuracy of ~ 0.9439562.
